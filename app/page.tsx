        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="text-2xl font-bold text-blue-500">AI Rookie</div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
                Get real AI outcomes in 60-90 minutes. Leave with working
                prompts, workflows, or tools built on your actual task—not a
                demo.
              </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:shadow-lg transition-shadow duration-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Leave with working prompts, a mini workflow, or a tool set
                    up—built on your actual task, not a demo.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    1:1 or small group with a vetted expert who adapts to your
                    level and stack (Docs, Sheets, Gmail, Notion, etc.).
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Plain-English explanations, quick wins first, and a simple
                    next-step plan so you keep momentum after the call.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    A short recap, your tailored prompt snippets, and a
                    checklist you can reuse—delivered to your inbox.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Book in 2 minutes, automatic calendar + Zoom, timezone-safe
                    scheduling, polite reminders.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-200">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">
                    No Awkwardness, No Risk
                  </h3>
                  <p className="text-gray-600">
                    Transparent pricing. Your card is only captured when the
                    expert accepts. Clear cancellation and refund rules.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Three simple steps to get real AI outcomes that work for your
                specific needs.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  e.g., "summarize customer emails daily" or "draft a policy
                  safely"
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Select your preferred expert and authorize payment when they
                  accept
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Join the session → build it together → get your recap + next
                  steps
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  A reusable prompt library for your weekly tasks
                </h3>
                <p className="text-gray-600">
                  Custom prompts that understand your specific role, industry,
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  A simple "data → summary" workflow
                </h3>
                <p className="text-gray-600">
                  e.g., email → sheet → report automation that actually works
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  A safe-to-use template for contracts, policies, or briefs
                </h3>
                <p className="text-gray-600">
                  Professional templates with built-in safeguards and clear
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-6 rounded-xl">
                ...
                <p className="text-gray-600">
                  No heavy IT needed—simple automations that integrate with your
                  current workflow.
                </p>
              </div>
            </div>
        ...
        <section className="py-16 sm:py-24 bg-gradient-to-r from-blue-500 to-blue-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Book your 60-90 minute session and walk away with working
      ...
      <footer className="bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-1">
              ...
              <p className="text-gray-500 mb-4">
                Real AI outcomes in 60-90 minutes. No fluff, no demos—just
                practical solutions for your actual tasks.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-200 pt-8 mt-8 text-center text-gray-500">
            <p>
              &copy; 2024 AI Rookie. All rights reserved. Real outcomes, not
              demos.
            </p>
          </div>
        </div>
